...
class SubjectPracticePage extends StatefulWidget {
  ...
  const SubjectPracticePage({Key? key, required this.subjectData})
      : super(key: key);

  @override
  _SubjectPracticePageState createState() => _SubjectPracticePageState();
}

class _SubjectPracticePageState extends State<SubjectPracticePage> {
  ...
  void _showPracticeSummary(BuildContext context) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Text(
          '${widget.subjectData['title']} Summary',
          style: TextStyle(color: widget.subjectData['color']),
        ),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ListTile(
              ...
              title: const Text('Completed Topics'),
              trailing: const Text('2/8'),
            ),
            ListTile(
            ...
            ListTile(
              leading:
                  Icon(Icons.trending_up, color: widget.subjectData['color']),
